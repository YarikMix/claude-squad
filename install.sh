...
get_latest_version() {
    ...
    API_RESPONSE=$(curl -sS "https://api.github.com/repos/YarikMix/claude-squad/releases")
    if [ $? -ne 0 ]; then
...
main() {
    ...
    RELEASE_URL="https://github.com/YarikMix/claude-squad/releases/download/v${VERSION}"
